...
const Photo = styled.img`
	...
	width: 32px;
`;
const AnyReactComponent = ({ text }) => <Photo src={text}></Photo>;
...
class GoogleMaps extends Component {
	...
	success = pos => {
		...
		if (
			...
			this.state.target.longitude === crd.longitude
		) {
		...
		return (
			<div>
				...
				<div style={{ height: "85vh", width: "100%" }}>
					<GoogleMapReact
						bootstrapURLKeys={{
							key: "AIzaSyDZPh3bfqIX-MJw4WhM8w7mos3hIR0MPmY"
						}}
					...
					>
						<div
							lat={this.state.lat}
							lng={this.state.lng}
							onClick={() => Router.push("/propertypage")}
						>
